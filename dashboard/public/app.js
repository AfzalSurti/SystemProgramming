...
async function loadAll(manual=false){ // load all incidents from server
    try{
        ...
        const error4xx=stats.error4xx ?? 0;
        const error5xx=stats.error5xx ?? 0;
        ...
        document.getElementById("stat4xx").textContent=error4xx;
        document.getElementById("stat5xx").textContent=error5xx;
